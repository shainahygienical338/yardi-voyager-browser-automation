/**
 * auth.js — Authentication handler for Yardi Voyager
 * Supports: SSO (Yardi Native / Azure AD), MFA (Yardi Two-Factor / Email OTP)
 *
...
const BASE_URL = process.env.YARDI_URL || 'https://www.yardiasp14.com/your-site/webforms/userlogin.aspx';
const USERNAME = process.env.YARDI_USERNAME;
const PASSWORD = process.env.YARDI_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set YARDI_USERNAME and YARDI_PASSWORD in .env`);
  }

  console.log('Logging in to Yardi Voyager...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
